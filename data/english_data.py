WORDS_FOR_LEARNING = {
    'путешествия': {
        "inception": "Английский для путешествий очень важная тема, она помогает во всем за гриницей!"
                     "\nВот темы которые мы изучим в этом разделе:"
                     "\nАнглийский для туристов в дороге"
                     "\nРегистрация и проживание в гостинице"
                     "\nИсследуем город"
        ...
        "themes": [
            {
                "title": "Бизнес английский совсем не такой сложный, как многим кажется."
                ...
                "youtude_title": "Вот видео о деловом английском",
                "youtube_urls": ["https://www.youtube.com/watch?v=4qPM4RspC60",
                                 "https://www.youtube.com/watch?v=caVK3vtmR6E"],
                "words": [['Buyer',
                           'покупатель. Пример: Our buyers are so general that thanks to them we can sell our products without extra charge => Наши покупатели настолько щедрые, что мы можем продавать наши товары без наценки.'],
                          ['Seller', 'продавец'],
                          ['Dealer',
                           'дилер'], ['Retailer',
                                      'розничный продавец'],
            ...
            {"title": "Лексика для маркетинга, рекламы и продаж",
             "youtude_title": "Полезные фразы для маркетинга, рекламы и продаж",
            ...
            {"title": "Полезные фразы для собеседования на английском",
             "youtude_title": "Видео о том, как проходить собеседования за границей",
        ...
        "inception": "Разговорный английский - тут нет теории!"
                     ...
                     "\nпо-переписоваться с другими пользователями бота по команде /get_people_to_chat,"
                     "\nты может пообщаться с Алисой команже /talk_to_Alice"
                     "\nузнай, чего не нужно бояться при речи, ведь это лишь тормозит процесс обучения,"
                     "по команде /recs_for_speakers"
                     "\n",
        "links": ['https://lim-english.com/posts/izychenie-razgovornogo-angliiskogo-yazika-samostoyatelno/',
                  "https://habr.com/ru/post/472754/"],
