WORDS_FOR_LEARNING = {
    'путешествия': {
        ...
        "themes": [
            {
                ...
                "words": [['Buyer',
                           'покупатель. Пример: Our buyers are so general that thanks to them we can sell our products without extra charge =>'
                           ' Наши покупатели настолько щедрые, что мы можем продавать наши товары без наценки.'],
                          ['Seller', 'продавец'],
                          ['Dealer',
                           'дилер'], ['Retailer',
                                      'розничный продавец'],
        ...
        "inception": "Разговорный английский - тут нет слов на зубрежку, каких то видео,"
                     " единственное что реально важно - говорить, и говорить реально много!",
